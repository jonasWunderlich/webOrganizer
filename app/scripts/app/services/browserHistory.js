...
angular.module('newTab').factory('BrowserHistory', function ($log, $http, $q, configuration, ChromeApi) {
   ...
   * @returns {promise}
   */
  var getHistoryWithVisits = function getHistoryWithVisits() {
    var deferredHistory = $q.defer();
    ChromeApi.getStorage('tabConnections').then(function (tabconnections) {
   ...
   * @returns {promise}
   */
  var getProcessedHistory = function getProcessedHistory() {

    var deferred = $q.defer();

    $q.all([getHistoryWithVisits(), ChromeApi.getBookmarks(), ChromeApi.getOpenTabs(), ChromeApi.getStorage()]).then(function (data) {
